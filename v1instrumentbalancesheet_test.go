...
func TestV1InstrumentBalanceSheetGetInstrumentBalanceSheetStatementsWithOptionalParams(t *testing.T) {
	...
	_, err := client.V1.Instruments.BalanceSheets.GetInstrumentBalanceSheetStatements(
		...
		clearstreet.V1InstrumentBalanceSheetGetInstrumentBalanceSheetStatementsParams{
