...
//
// ActiveV1InstrumentOptionContractService contains methods and other services that
// help with interacting with the clear-street API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewActiveV1InstrumentOptionContractService] method instead.
type ActiveV1InstrumentOptionContractService struct {
	options []option.RequestOption
}

// NewActiveV1InstrumentOptionContractService generates a new service that applies
// the given options to each request. These options are applied after the parent
// client's options (if there is one), and before any request-specific options.
func NewActiveV1InstrumentOptionContractService(opts ...option.RequestOption) (r ActiveV1InstrumentOptionContractService) {
	r = ActiveV1InstrumentOptionContractService{}
	r.options = opts
	return
}
...
type ActiveV1InstrumentOptionContractGetOptionContractsResponse struct {
...
func (r ActiveV1InstrumentOptionContractGetOptionContractsResponse) RawJSON() string {
	return r.JSON.raw
}
func (r *ActiveV1InstrumentOptionContractGetOptionContractsResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type ActiveV1InstrumentOptionContractGetOptionContractsParams struct {
...
// URLQuery serializes [ActiveV1InstrumentOptionContractGetOptionContractsParams]'s
// query parameters as `url.Values`.
func (r ActiveV1InstrumentOptionContractGetOptionContractsParams) URLQuery() (v url.Values, err error) {
