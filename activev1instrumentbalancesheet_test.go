...
func TestActiveV1InstrumentBalanceSheetGetInstrumentBalanceSheetStatementsWithOptionalParams(t *testing.T) {
	...
	_, err := client.Active.V1.Instruments.BalanceSheets.GetInstrumentBalanceSheetStatements(
		context.TODO(),
		"security_id",
		clearstreet.ActiveV1InstrumentBalanceSheetGetInstrumentBalanceSheetStatementsParams{
