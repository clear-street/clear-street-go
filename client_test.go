...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.V1.Accounts.GetAccounts(context.Background(), clearstreet.V1AccountGetAccountsParams{})
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.V1.Accounts.GetAccounts(context.Background(), clearstreet.V1AccountGetAccountsParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.V1.Accounts.GetAccounts(cancelCtx, clearstreet.V1AccountGetAccountsParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.V1.Accounts.GetAccounts(deadlineCtx, clearstreet.V1AccountGetAccountsParams{})
		if err == nil {
