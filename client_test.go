...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Active.V1.Accounts.GetAccounts(context.Background(), clearstreet.ActiveV1AccountGetAccountsParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Active.V1.Accounts.GetAccounts(cancelCtx, clearstreet.ActiveV1AccountGetAccountsParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Active.V1.Accounts.GetAccounts(deadlineCtx, clearstreet.ActiveV1AccountGetAccountsParams{})
		if err == nil {
