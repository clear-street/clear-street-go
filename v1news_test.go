...
func TestV1NewsGetNewsWithOptionalParams(t *testing.T) {
	...
	_, err := client.V1.News.GetNews(context.TODO(), clearstreet.V1NewsGetNewsParams{
		...
		NewsType:          clearstreet.V1NewsGetNewsParamsNewsTypeNews,
