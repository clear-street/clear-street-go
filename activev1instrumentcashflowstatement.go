...
//
// ActiveV1InstrumentCashFlowStatementService contains methods and other services
// that help with interacting with the clear-street API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewActiveV1InstrumentCashFlowStatementService] method instead.
type ActiveV1InstrumentCashFlowStatementService struct {
	options []option.RequestOption
}

// NewActiveV1InstrumentCashFlowStatementService generates a new service that
// applies the given options to each request. These options are applied after the
// parent client's options (if there is one), and before any request-specific
// options.
func NewActiveV1InstrumentCashFlowStatementService(opts ...option.RequestOption) (r ActiveV1InstrumentCashFlowStatementService) {
	r = ActiveV1InstrumentCashFlowStatementService{}
	r.options = opts
	return
}
...
func (r *ActiveV1InstrumentCashFlowStatementService) GetInstrumentCashFlowStatements(ctx context.Context, securityID string, params ActiveV1InstrumentCashFlowStatementGetInstrumentCashFlowStatementsParams, opts ...option.RequestOption) (res *ActiveV1InstrumentCashFlowStatementGetInstrumentCashFlowStatementsResponse, err error) {
	opts = slices.Concat(r.options, opts)
	if securityID == "" {
		err = errors.New("missing required security_id parameter")
		return nil, err
	}
	path := fmt.Sprintf("active/v1/instruments/%v/%s/cash-flow-statements", params.SecurityIDSource, url.PathEscape(securityID))
...
type ActiveV1InstrumentCashFlowStatementGetInstrumentCashFlowStatementsResponse struct {
...
// Returns the unmodified JSON received from the API
func (r ActiveV1InstrumentCashFlowStatementGetInstrumentCashFlowStatementsResponse) RawJSON() string {
	return r.JSON.raw
}
func (r *ActiveV1InstrumentCashFlowStatementGetInstrumentCashFlowStatementsResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type ActiveV1InstrumentCashFlowStatementGetInstrumentCashFlowStatementsParams struct {
...
// URLQuery serializes
// [ActiveV1InstrumentCashFlowStatementGetInstrumentCashFlowStatementsParams]'s
// query parameters as `url.Values`.
func (r ActiveV1InstrumentCashFlowStatementGetInstrumentCashFlowStatementsParams) URLQuery() (v url.Values, err error) {
