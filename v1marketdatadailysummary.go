...
//
// V1MarketDataDailySummaryService contains methods and other services that help
// with interacting with the clear-street API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewV1MarketDataDailySummaryService] method instead.
type V1MarketDataDailySummaryService struct {
	options []option.RequestOption
}

// NewV1MarketDataDailySummaryService generates a new service that applies the
// given options to each request. These options are applied after the parent
// client's options (if there is one), and before any request-specific options.
func NewV1MarketDataDailySummaryService(opts ...option.RequestOption) (r V1MarketDataDailySummaryService) {
	r = V1MarketDataDailySummaryService{}
	r.options = opts
	return
}
...
func (r *V1MarketDataDailySummaryService) GetDailySummaries(ctx context.Context, query V1MarketDataDailySummaryGetDailySummariesParams, opts ...option.RequestOption) (res *V1MarketDataDailySummaryGetDailySummariesResponse, err error) {
...
type V1MarketDataDailySummaryGetDailySummariesResponse struct {
...
// Returns the unmodified JSON received from the API
func (r V1MarketDataDailySummaryGetDailySummariesResponse) RawJSON() string { return r.JSON.raw }
func (r *V1MarketDataDailySummaryGetDailySummariesResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type V1MarketDataDailySummaryGetDailySummariesParams struct {
	// Comma-separated OEMS instrument UUIDs (required, 1..=100)
	InstrumentIDs string `query:"instrument_ids" api:"required" json:"-"`
	paramObj
}

// URLQuery serializes [V1MarketDataDailySummaryGetDailySummariesParams]'s query
// parameters as `url.Values`.
func (r V1MarketDataDailySummaryGetDailySummariesParams) URLQuery() (v url.Values, err error) {
