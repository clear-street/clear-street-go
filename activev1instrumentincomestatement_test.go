...
func TestActiveV1InstrumentIncomeStatementGetInstrumentIncomeStatementsWithOptionalParams(t *testing.T) {
	...
	_, err := client.Active.V1.Instruments.IncomeStatements.GetInstrumentIncomeStatements(
		context.TODO(),
		"security_id",
		clearstreet.ActiveV1InstrumentIncomeStatementGetInstrumentIncomeStatementsParams{
