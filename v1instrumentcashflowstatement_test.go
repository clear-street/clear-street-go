...
func TestV1InstrumentCashFlowStatementGetInstrumentCashFlowStatementsWithOptionalParams(t *testing.T) {
	...
	_, err := client.V1.Instruments.CashFlowStatements.GetInstrumentCashFlowStatements(
		...
		clearstreet.V1InstrumentCashFlowStatementGetInstrumentCashFlowStatementsParams{
