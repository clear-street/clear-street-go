...
//
// ActiveV1InstrumentBalanceSheetService contains methods and other services that
// help with interacting with the clear-street API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewActiveV1InstrumentBalanceSheetService] method instead.
type ActiveV1InstrumentBalanceSheetService struct {
	options []option.RequestOption
}

// NewActiveV1InstrumentBalanceSheetService generates a new service that applies
// the given options to each request. These options are applied after the parent
// client's options (if there is one), and before any request-specific options.
func NewActiveV1InstrumentBalanceSheetService(opts ...option.RequestOption) (r ActiveV1InstrumentBalanceSheetService) {
	r = ActiveV1InstrumentBalanceSheetService{}
	r.options = opts
	return
}
...
func (r *ActiveV1InstrumentBalanceSheetService) GetInstrumentBalanceSheetStatements(ctx context.Context, securityID string, params ActiveV1InstrumentBalanceSheetGetInstrumentBalanceSheetStatementsParams, opts ...option.RequestOption) (res *ActiveV1InstrumentBalanceSheetGetInstrumentBalanceSheetStatementsResponse, err error) {
	opts = slices.Concat(r.options, opts)
	if securityID == "" {
		err = errors.New("missing required security_id parameter")
		return nil, err
	}
	path := fmt.Sprintf("active/v1/instruments/%v/%s/balance-sheets", params.SecurityIDSource, url.PathEscape(securityID))
...
type ActiveV1InstrumentBalanceSheetGetInstrumentBalanceSheetStatementsResponse struct {
...
// Returns the unmodified JSON received from the API
func (r ActiveV1InstrumentBalanceSheetGetInstrumentBalanceSheetStatementsResponse) RawJSON() string {
	return r.JSON.raw
}
func (r *ActiveV1InstrumentBalanceSheetGetInstrumentBalanceSheetStatementsResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type ActiveV1InstrumentBalanceSheetGetInstrumentBalanceSheetStatementsParams struct {
...
// URLQuery serializes
// [ActiveV1InstrumentBalanceSheetGetInstrumentBalanceSheetStatementsParams]'s
// query parameters as `url.Values`.
func (r ActiveV1InstrumentBalanceSheetGetInstrumentBalanceSheetStatementsParams) URLQuery() (v url.Values, err error) {
