...
func TestV1InstrumentAnalystReportingGetInstrumentAnalystConsensusWithOptionalParams(t *testing.T) {
	...
	_, err := client.V1.Instruments.AnalystReporting.GetInstrumentAnalystConsensus(
		...
		clearstreet.V1InstrumentAnalystReportingGetInstrumentAnalystConsensusParams{
