...
<a href="https://pkg.go.dev/github.com/stainless-sdks/clear-street-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/clear-street-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Clear Street Go library provides convenient access to the Clear Street REST API
...
[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=%40clear-street-internal%2Fsdk-mcp&config=eyJuYW1lIjoiQGNsZWFyLXN0cmVldC1pbnRlcm5hbC9zZGstbWNwIiwidHJhbnNwb3J0IjoiaHR0cCIsInVybCI6Imh0dHBzOi8vY2xlYXItc3RyZWV0LnN0bG1jcC5jb20ifQ)
[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22%40clear-street-internal%2Fsdk-mcp%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fclear-street.stlmcp.com%22%7D)
...
```go
import (
	"github.com/stainless-sdks/clear-street-go" // imported as clearstreet
)
```
...
```sh
go get -u 'github.com/stainless-sdks/clear-street-go@v0.0.1'
```
...
The clearstreet library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/clear-street-go/option).
...
`*clearstreet.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `clearstreet.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/clear-street-go/issues) with questions, bugs, or suggestions.
