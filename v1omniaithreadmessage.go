...
// trading_account_ids.
//
// V1OmniAIThreadMessageService contains methods and other services that help with
// interacting with the clear-street API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewV1OmniAIThreadMessageService] method instead.
type V1OmniAIThreadMessageService struct {
	options []option.RequestOption
}

// NewV1OmniAIThreadMessageService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewV1OmniAIThreadMessageService(opts ...option.RequestOption) (r V1OmniAIThreadMessageService) {
	r = V1OmniAIThreadMessageService{}
	r.options = opts
	return
}
...
// assistant output.
func (r *V1OmniAIThreadMessageService) NewMessage(ctx context.Context, threadID string, body V1OmniAIThreadMessageNewMessageParams, opts ...option.RequestOption) (res *V1OmniAIThreadMessageNewMessageResponse, err error) {
...
type V1OmniAIThreadMessageNewMessageResponse struct {
...
func (r V1OmniAIThreadMessageNewMessageResponse) RawJSON() string { return r.JSON.raw }
func (r *V1OmniAIThreadMessageNewMessageResponse) UnmarshalJSON(data []byte) error {
...
type V1OmniAIThreadMessageNewMessageParams struct {
...
func (r V1OmniAIThreadMessageNewMessageParams) MarshalJSON() (data []byte, err error) {
	type shadow V1OmniAIThreadMessageNewMessageParams
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *V1OmniAIThreadMessageNewMessageParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
