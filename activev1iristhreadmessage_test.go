...
func TestActiveV1IrisThreadMessageListMessagesWithOptionalParams(t *testing.T) {
	...
	_, err := client.Active.V1.Iris.Threads.Messages.ListMessages(
		context.TODO(),
		"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
		clearstreet.ActiveV1IrisThreadMessageListMessagesParams{
